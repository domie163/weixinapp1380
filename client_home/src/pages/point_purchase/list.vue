<template>
	<view class="page_point_purchase diy_list diy_list_page div_list_tml" id="point_purchase_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
															<uni-search-bar placeholder="搜索积分卡号" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'credit_card_number')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索购买积分" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'purchase_points')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
														<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?point_purchase_id=' + o['point_purchase_id']" class="btn btn-primary">查看详情</navigator>
