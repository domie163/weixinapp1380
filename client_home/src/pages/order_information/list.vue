			...
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
																					<uni-search-bar placeholder="搜索租赁时长" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'lease_duration')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																				<uni-search-bar placeholder="搜索消费积分" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'consumption_points')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
														<!-- /搜索栏 -->
						</view>
