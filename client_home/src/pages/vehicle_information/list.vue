<template>
	<view class="page_vehicle_information diy_list diy_list_page div_list_tml" id="vehicle_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
														<uni-search-bar placeholder="搜索车牌号" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'license_plate_number')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索车主姓名" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'owners_name')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
															<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?vehicle_information_id=' + o['vehicle_information_id']" class="btn btn-primary">查看详情</navigator>
