<template>
  <view class="page_vehicle_information diy_table diy_table_tml" id="vehicle_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="车牌号" name="license_plate_number">
                      <uni-easyinput type="text" v-model="query.license_plate_number" placeholder="车牌号" />
                    </uni-forms-item>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/vehicle_information/view?" v-show="user_group == '管理员' || $check_action('/vehicle_information/table','add') || $check_action('/vehicle_information/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','license_plate_number')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>车牌号</span>
							</view>
								...
								<span>
									{{ o["license_plate_number"] }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="1 && $check_field('get','owners_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>车主姓名</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','vehicle_photos')">
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>车辆照片</span>
							</view>
															<view class="diy_field diy_img">
									<img :src="$fullUrl(o['vehicle_photos'])" width="100%" height="100" />
								</view>
													</view>
					</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/vehicle_information/table','del') || $check_action('/vehicle_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/vehicle_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/vehicle_information/table','set') || $check_action('/vehicle_information/view','set') || $check_action('/vehicle_information/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
