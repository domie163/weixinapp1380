<template>
	<view class="diy_details diy_div_release_parking_spaces">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','parking_address')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>车位地址:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','shared_time')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>共享时间:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','lease_instructions')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>租借说明:</span>
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/release_parking_spaces/get_obj", {
					release_parking_spaces_id:this.query.release_parking_spaces_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["release_parking_spaces_id"] !==0) {
...
<style scoped>
	.div_release_parking_spaces_details {}
