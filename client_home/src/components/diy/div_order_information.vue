		...
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','lease_duration')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>租赁时长:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','consumption_points')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>消费积分:</span>
						</view>
							<view class="diy_field diy_text">
							<text>
								{{obj["consumption_points"]}}
							</text>
						</view>
						</view>
					<view v-if="$check_field('get','consumption_instructions')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>消费说明:</span>
						</view>
